...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		// TODO - DONE Create a new intent to launch the ExplicitlyLoadedActivity class
		Intent explicitIntent = new Intent(getBaseContext(),ExplicitlyLoadedActivity.class); 
		
		// TODO - DONE Start an Activity using that intent and the request code defined above
	...
	private void startImplicitActivation() {
		...
		// TODO - DONE Create a base intent for viewing a URL
		// (HINT:  second parameter uses Uri.parse())
		
        Intent baseIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.google.com"));
		
		// TODO - DONE Create a chooser intent, for choosing which Activity
		...
		// TODO - DONE Start the chooser Activity, using the chooser intent
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// TODO - DONE Process the result only if this method received both a
